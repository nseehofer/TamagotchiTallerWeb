    ...
    public static void limpiarBaseDeDatos() {
        try {
            ...
            String sqlCommands = "DELETE FROM Mascota; DELETE FROM Usuario; " +
                    ...
                    "INSERT INTO Mascota(id, energia, estaVivo, estaEnfermo, felicidad, hambre, higiene, nombre, salud, "
                    +
                    "ultimaAlimentacion, ultimaHigiene, ultimaSiesta, usuario_id, estaAbrigada) " +
                    "VALUES " +
